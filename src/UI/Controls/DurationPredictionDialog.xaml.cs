...
public sealed partial class DurationPredictionDialog : Page
{
    public static readonly int SelectionTimes =1000;

    public DurationPredictionDialog(TodoManager TodoManager, int duration)
    {
        InitializeComponent();
...
public class PredictionItem
{
    ...
    public double Probability {
        get => (double) Math.Round(Convert.ToDecimal(Count) /
                    Convert.ToDecimal(DurationPredictionDialog.SelectionTimes),2);
    }
}
